...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
    ...
    MO(_SYMBOLS),KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                        KC_H,    KC_J,     KC_K,    KC_L,    LT(_MEDIA, KC_SCLN), KC_QUOT ,
    KC_LSFT,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                        KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH,             KC_RSHIFT ,
    KC_LCTL,     KC_LGUI, KC_LALT, KC_GRV,  KC_LCTL, KC_BSPC, KC_TAB,   KC_ENT,   KC_SPC,  KC_RCTL,  KC_MINS, KC_QUOT, KC_ENT,              KC_RGUI
  ),
  
  [_SYMBOLS] = LAYOUT(
    KC_TRNS,  KC_F1,      KC_F2,   KC_F3,       KC_F4,       KC_F5,                       KC_F6,         KC_F7,         KC_F8,         KC_F9,         KC_F10,  KC_F11  ,
    KC_TRNS,  KC_TRNS,    KC_TRNS, KC_LCBR,     KC_RCBR,     KC_TRNS,                     KC_F12,        KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS, KC_TRNS ,
    KC_TRNS,  KC_TRNS,    KC_TRNS, KC_LPRN,     KC_RPRN,     KC_TRNS,                     KC_LEFT,       KC_DOWN,       KC_UP  ,       KC_RGHT,       KC_TRNS, KC_TRNS ,
    KC_TRNS,  KC_TRNS,    KC_TRNS, KC_LBRACKET, KC_RBRACKET, KC_TRNS,                     LSFT(KC_LEFT), LSFT(KC_DOWN), LSFT(KC_UP)  , LSFT(KC_RGHT), KC_TRNS, KC_TRNS ,
    KC_TRNS,  TO(_RESET), KC_TRNS, KC_TRNS,     KC_TRNS,     KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS, TO(_GAME)
  ),
  ...
  [_GAME] = LAYOUT(
    ...
    KC_NO  ,  KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   ,                     KC_NO  , KC_NO  , KC_NO  , KC_NO   , KC_NO  , KC_NO     ,
    KC_M   ,  KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,  KC_SPACE, KC_NO  , KC_NO  , KC_NO  , KC_NO   , KC_NO  , TO(_DEFAULT)
  ),
